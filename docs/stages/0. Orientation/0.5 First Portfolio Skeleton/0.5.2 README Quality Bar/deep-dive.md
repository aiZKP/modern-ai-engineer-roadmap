...
- Input: identify what raw information, code, data, prompt, model output, trace, or user signal README Quality Bar consumes.
...
- Failure mode: record how README Quality Bar can fail specifically in Orientation, not only in theory.
...
A strong learner can point to a small artifact, explain the tradeoff, show a measurement, and name the next improvement. For README Quality Bar, that means the explanation is grounded in First Portfolio Skeleton and the stage artifact rather than floating as general AI vocabulary.
