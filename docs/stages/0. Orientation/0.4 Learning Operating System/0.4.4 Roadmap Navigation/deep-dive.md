...
- Input: identify what raw information, code, data, prompt, model output, trace, or user signal Roadmap Navigation consumes.
...
- Failure mode: record how Roadmap Navigation can fail specifically in Orientation, not only in theory.
...
A strong learner can point to a small artifact, explain the tradeoff, show a measurement, and name the next improvement. For Roadmap Navigation, that means the explanation is grounded in Learning Operating System and the stage artifact rather than floating as general AI vocabulary.
