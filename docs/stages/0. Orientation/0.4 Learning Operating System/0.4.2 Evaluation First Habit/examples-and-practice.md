# Examples and Practice: Evaluation First Habit

## Worked Practice

1. Write one paragraph explaining Evaluation First Habit to a beginner.
...
Create a file named `notes/evaluation-first-habit.md` in your project workspace. Include:

- the problem Evaluation First Habit solves
...
|---|---|
| Why does Evaluation First Habit matter? | It connects to a learning log, environment checklist, use-case decision memo, and first roadmap plan. and names a practical risk. |
