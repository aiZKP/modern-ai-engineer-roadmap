# Deep Dive: Evaluation First Habit
...
- Input: identify what raw information, code, data, prompt, model output, trace, or user signal Evaluation First Habit consumes.
...
- Failure mode: record how Evaluation First Habit can fail specifically in Orientation, not only in theory.
...
A strong learner can point to a small artifact, explain the tradeoff, show a measurement, and name the next improvement. For Evaluation First Habit, that means the explanation is grounded in Learning Operating System and the stage artifact rather than floating as general AI vocabulary.

Return to [0.4.2 Evaluation First Habit](<index.md>).
