...
- Input: identify what raw information, code, data, prompt, model output, trace, or user signal Use Case Selection consumes.
...
- Failure mode: record how Use Case Selection can fail specifically in Orientation, not only in theory.
...
A strong learner can point to a small artifact, explain the tradeoff, show a measurement, and name the next improvement. For Use Case Selection, that means the explanation is grounded in Use Case Judgment and the stage artifact rather than floating as general AI vocabulary.
