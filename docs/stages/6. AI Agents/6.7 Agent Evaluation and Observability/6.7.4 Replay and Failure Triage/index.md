# 6.7.4 Replay and Failure Triage
...
- Define Replay and Failure Triage in plain language before naming tools or frameworks.
...
- Measure it with: success, trace completeness, tool errors, cost, and latency
...
4. Add one measurement using: Track success, trace completeness, tool errors, cost, and latency.

## Completion Standard

- I can explain Replay and Failure Triage without naming a tool first.
...
Return to [6.7 Agent Evaluation and Observability](<../index.md>).
