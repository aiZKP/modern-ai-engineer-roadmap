# 6.1.1 Agent State and Messages
...
- Define Agent State and Messages in plain language before naming tools or frameworks.
...
- I can explain Agent State and Messages without naming a tool first.
