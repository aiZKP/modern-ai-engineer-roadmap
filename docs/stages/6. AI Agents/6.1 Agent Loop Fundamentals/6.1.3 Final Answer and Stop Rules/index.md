# 6.1.3 Final Answer and Stop Rules
...
- Define Final Answer and Stop Rules in plain language before naming tools or frameworks.
...
- Measure it with: steps, success, invalid actions, and stop reasons
...
4. Add one measurement using: Track steps, success, invalid actions, and stop reasons.

## Completion Standard

- I can explain Final Answer and Stop Rules without naming a tool first.
...
Return to [6.1 Agent Loop Fundamentals](<../index.md>).
