# Examples and Practice: Working Memory

## Worked Practice

1. Write one paragraph explaining Working Memory to a beginner.
...
Create a file named `notes/working-memory.md` in your project workspace. Include:

- the problem Working Memory solves
...
|---|---|
| Why does Working Memory matter? | It connects to a tool-using agent with typed tools, memory, traces, task evals, prompt-injection tests, and an architecture readme. and names a practical risk. |
