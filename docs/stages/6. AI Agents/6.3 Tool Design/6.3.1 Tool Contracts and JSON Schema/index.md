# 6.3.1 Tool Contracts and JSON Schema
...
- Define Tool Contracts and JSON Schema in plain language before naming tools or frameworks.
...
- I can explain Tool Contracts and JSON Schema without naming a tool first.
