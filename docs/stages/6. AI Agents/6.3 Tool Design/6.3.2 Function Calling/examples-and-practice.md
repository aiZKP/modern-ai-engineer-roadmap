# Examples and Practice: Function Calling

## Worked Practice

1. Write one paragraph explaining Function Calling to a beginner.
...
Create a file named `notes/function-calling.md` in your project workspace. Include:
...
|---|---|
| Why does Function Calling matter? | It connects to a tool-using agent with typed tools, memory, traces, task evals, prompt-injection tests, and an architecture readme. and names a practical risk. |
