# 6.3.4 Idempotency and Side Effects
...
- Define Idempotency and Side Effects in plain language before naming tools or frameworks.
...
- Measure it with: schema validity, tool success, retries, and permission blocks
...
4. Add one measurement using: Track schema validity, tool success, retries, and permission blocks.

## Completion Standard

- I can explain Idempotency and Side Effects without naming a tool first.
...
Return to [6.3 Tool Design](<../index.md>).
