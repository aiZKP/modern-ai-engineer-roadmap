# Examples and Practice: Agents as Tools

## Worked Practice

1. Write one paragraph explaining Agents as Tools to a beginner.
...
Create a file named `notes/agents-as-tools.md` in your project workspace. Include:

- the problem Agents as Tools solves
...
|---|---|
| Why does Agents as Tools matter? | It connects to a tool-using agent with typed tools, memory, traces, task evals, prompt-injection tests, and an architecture readme. and names a practical risk. |
