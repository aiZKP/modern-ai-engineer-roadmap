# 6.8.1 Prompt Injection Against Agents
...
- Define Prompt Injection Against Agents in plain language before naming tools or frameworks.
...
- I can explain Prompt Injection Against Agents without naming a tool first.
...
Return to [6.8 Agent Security and Safety](<../index.md>).
