# 6.8.2 Least Privilege Tool Access
...
- Define Least Privilege Tool Access in plain language before naming tools or frameworks.
...
- I can explain Least Privilege Tool Access without naming a tool first.
