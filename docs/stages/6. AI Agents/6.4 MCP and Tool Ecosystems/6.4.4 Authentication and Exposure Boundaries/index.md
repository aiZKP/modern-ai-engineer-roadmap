# 6.4.4 Authentication and Exposure Boundaries
...
- Define Authentication and Exposure Boundaries in plain language before naming tools or frameworks.
...
- Measure it with: exposed resources, permissions, auth, and host integration
...
4. Add one measurement using: Track exposed resources, permissions, auth, and host integration.

## Completion Standard

- I can explain Authentication and Exposure Boundaries without naming a tool first.
...
Return to [6.4 MCP and Tool Ecosystems](<../index.md>).
