# Examples and Practice: MCP Hosts Clients and Servers

## Worked Practice

1. Write one paragraph explaining MCP Hosts Clients and Servers to a beginner.
...
Create a file named `notes/mcp-hosts-clients-and-servers.md` in your project workspace. Include:

- the problem MCP Hosts Clients and Servers solves
...
|---|---|
| Why does MCP Hosts Clients and Servers matter? | It connects to a tool-using agent with typed tools, memory, traces, task evals, prompt-injection tests, and an architecture readme. and names a practical risk. |
...
Return to [6.4.1 MCP Hosts Clients and Servers](<index.md>).
