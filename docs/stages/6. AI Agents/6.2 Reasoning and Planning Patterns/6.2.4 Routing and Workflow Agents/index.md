# 6.2.4 Routing and Workflow Agents
...
- Define Routing and Workflow Agents in plain language before naming tools or frameworks.
...
- Measure it with: quality, cost, latency, and debuggability
...
4. Add one measurement using: Track quality, cost, latency, and debuggability.

## Completion Standard

- I can explain Routing and Workflow Agents without naming a tool first.
...
Return to [6.2 Reasoning and Planning Patterns](<../index.md>).
