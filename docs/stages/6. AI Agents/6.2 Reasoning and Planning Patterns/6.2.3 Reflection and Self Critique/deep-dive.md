# Deep Dive: Reflection and Self Critique
...
- Input: identify what raw information, code, data, prompt, model output, trace, or user signal Reflection and Self Critique consumes.
...
- Failure mode: record how Reflection and Self Critique can fail specifically in AI Agents, not only in theory.
...
A strong learner can point to a small artifact, explain the tradeoff, show a measurement, and name the next improvement. For Reflection and Self Critique, that means the explanation is grounded in Reasoning and Planning Patterns and the stage artifact rather than floating as general AI vocabulary.

Return to [6.2.3 Reflection and Self Critique](<index.md>).
