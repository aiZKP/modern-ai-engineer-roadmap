# 9.5.3 MEV Front Running and Oracle Risk
...
- Define MEV Front Running and Oracle Risk in plain language before naming tools or frameworks.
...
- I can explain MEV Front Running and Oracle Risk without naming a tool first.
...
Return to [9.5 Smart Contract Security](<../index.md>).
