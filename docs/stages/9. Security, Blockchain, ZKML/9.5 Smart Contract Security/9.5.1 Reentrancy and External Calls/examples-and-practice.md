# Examples and Practice: Reentrancy and External Calls

## Worked Practice

1. Write one paragraph explaining Reentrancy and External Calls to a beginner.
2. Draw the smallest diagram that shows input, transformation, output, and failure mode.
3. Build or outline a tiny artifact connected to: Create vulnerable contracts, exploits, and fixes.
4. Measure it with: Track vulnerabilities reproduced, tests added, gas impact, and residual risk.
5. Add one failure case to your learning log.

## Mini Project Drill

Create a file named `notes/reentrancy-and-external-calls.md` in your project workspace. Include:

- the problem Reentrancy and External Calls solves
...
|---|---|
| Why does Reentrancy and External Calls matter? | It connects to a threat model, red-team report, smart contract security lab, and tiny zkml or verifiable computation demo. and names a practical risk. |
