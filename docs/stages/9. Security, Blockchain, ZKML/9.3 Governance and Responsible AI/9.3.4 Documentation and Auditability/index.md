# 9.3.4 Documentation and Auditability
...
- Define Documentation and Auditability in plain language before naming tools or frameworks.
...
- Measure it with: risk treatment, oversight, monitoring, and documentation completeness
...
4. Add one measurement using: Track risk treatment, oversight, monitoring, and documentation completeness.

## Completion Standard

- I can explain Documentation and Auditability without naming a tool first.
...
Return to [9.3 Governance and Responsible AI](<../index.md>).
