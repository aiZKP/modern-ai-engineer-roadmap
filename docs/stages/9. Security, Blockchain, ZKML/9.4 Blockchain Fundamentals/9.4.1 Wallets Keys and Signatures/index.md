# 9.4.1 Wallets Keys and Signatures
...
- Define Wallets Keys and Signatures in plain language before naming tools or frameworks.
...
- Measure it with: keys, permissions, transaction simulation, gas, and rollback assumptions
...
4. Add one measurement using: Track keys, permissions, transaction simulation, gas, and rollback assumptions.

## Completion Standard

- I can explain Wallets Keys and Signatures without naming a tool first.
...
Return to [9.4 Blockchain Fundamentals](<../index.md>).
