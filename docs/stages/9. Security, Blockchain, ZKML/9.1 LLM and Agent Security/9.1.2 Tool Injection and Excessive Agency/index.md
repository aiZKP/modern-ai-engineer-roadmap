# 9.1.2 Tool Injection and Excessive Agency
...
- Define Tool Injection and Excessive Agency in plain language before naming tools or frameworks.
...
- I can explain Tool Injection and Excessive Agency without naming a tool first.
...
Return to [9.1 LLM and Agent Security](<../index.md>).
