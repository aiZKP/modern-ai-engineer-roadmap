# Examples and Practice: ZKML Use Cases and Limits

## Worked Practice

1. Write one paragraph explaining ZKML Use Cases and Limits to a beginner.
...
Create a file named `notes/zkml-use-cases-and-limits.md` in your project workspace. Include:

- the problem ZKML Use Cases and Limits solves
...
|---|---|
| Why does ZKML Use Cases and Limits matter? | It connects to a threat model, red-team report, smart contract security lab, and tiny zkml or verifiable computation demo. and names a practical risk. |
