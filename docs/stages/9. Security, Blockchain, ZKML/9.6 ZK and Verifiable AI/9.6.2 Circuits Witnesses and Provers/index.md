# 9.6.2 Circuits Witnesses and Provers
...
- Define Circuits Witnesses and Provers in plain language before naming tools or frameworks.
...
- Measure it with: circuit size, proving time, verification time, precision loss, and model limits
...
4. Add one measurement using: Track circuit size, proving time, verification time, precision loss, and model limits.

## Completion Standard

- I can explain Circuits Witnesses and Provers without naming a tool first.
...
Return to [9.6 ZK and Verifiable AI](<../index.md>).
