...
- Define Crawlers and Connectors in plain language before naming tools or frameworks.
...
- I can explain Crawlers and Connectors without naming a tool first.
...
Return to [7.1 Data Pipeline Architecture](<../index.md>).
