# 8.2.3 GEMM GEMV and MLP Blocks
...
- Define GEMM GEMV and MLP Blocks in plain language before naming tools or frameworks.
...
- I can explain GEMM GEMV and MLP Blocks without naming a tool first.
