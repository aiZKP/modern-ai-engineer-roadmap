# 8.1.2 Prefill Decode and KV Cache

## Why This Sub-Part Matters

Prefill Decode and KV Cache is the working skill inside Inference Performance Model that helps you build the stage artifact, An inference benchmark and optimization report for an open-weight or hosted model workload, while collecting enough evidence to trust the result. A sub-part is now a folder so longer topics can grow without forcing everything into one huge page.
...
- Define Prefill Decode and KV Cache in plain language before naming tools or frameworks.
...
- Measure it with: TTFT, TPOT, throughput, p95, memory, and quality
...
4. Add one measurement using: Track TTFT, TPOT, throughput, p95, memory, and quality.

## Completion Standard

- I can explain Prefill Decode and KV Cache without naming a tool first.
...
Return to [8.1 Inference Performance Model](<../index.md>).
