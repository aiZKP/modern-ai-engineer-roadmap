# 8.4.1 vLLM SGLang TGI and TensorRT LLM

## Why This Sub-Part Matters

vLLM SGLang TGI and TensorRT LLM is the working skill inside Serving Engines that helps you build the stage artifact, An inference benchmark and optimization report for an open-weight or hosted model workload, while collecting enough evidence to trust the result. A sub-part is now a folder so longer topics can grow without forcing everything into one huge page.
...
- Define vLLM SGLang TGI and TensorRT LLM in plain language before naming tools or frameworks.
...
- Measure it with: throughput, p95, memory, utilization, errors, and cost
...
4. Add one measurement using: Track throughput, p95, memory, utilization, errors, and cost.

## Completion Standard

- I can explain vLLM SGLang TGI and TensorRT LLM without naming a tool first.
...
Return to [8.4 Serving Engines](<../index.md>).
