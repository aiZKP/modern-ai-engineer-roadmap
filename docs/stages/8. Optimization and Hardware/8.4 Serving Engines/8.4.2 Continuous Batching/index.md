# 8.4.2 Continuous Batching

## Why This Sub-Part Matters

Continuous Batching is the working skill inside Serving Engines that helps you build the stage artifact, An inference benchmark and optimization report for an open-weight or hosted model workload, while collecting enough evidence to trust the result. A sub-part is now a folder so longer topics can grow without forcing everything into one huge page.
...
- Define Continuous Batching in plain language before naming tools or frameworks.
...
- I can explain Continuous Batching without naming a tool first.
