# 8.6.1 CUDA Threads Blocks and Warps
...
- Define CUDA Threads Blocks and Warps in plain language before naming tools or frameworks.
...
- I can explain CUDA Threads Blocks and Warps without naming a tool first.
