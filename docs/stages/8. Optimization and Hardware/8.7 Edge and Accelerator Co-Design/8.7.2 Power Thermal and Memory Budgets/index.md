# 8.7.2 Power Thermal and Memory Budgets

## Why This Sub-Part Matters

Power Thermal and Memory Budgets is the working skill inside Edge and Accelerator Co-Design that helps you build the stage artifact, An inference benchmark and optimization report for an open-weight or hosted model workload, while collecting enough evidence to trust the result. A sub-part is now a folder so longer topics can grow without forcing everything into one huge page.
...
- Define Power Thermal and Memory Budgets in plain language before naming tools or frameworks.
...
- I can explain Power Thermal and Memory Budgets without naming a tool first.
