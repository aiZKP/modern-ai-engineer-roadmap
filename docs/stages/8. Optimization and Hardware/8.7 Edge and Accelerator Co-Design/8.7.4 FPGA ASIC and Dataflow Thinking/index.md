# 8.7.4 FPGA ASIC and Dataflow Thinking

## Why This Sub-Part Matters

FPGA ASIC and Dataflow Thinking is the working skill inside Edge and Accelerator Co-Design that helps you build the stage artifact, An inference benchmark and optimization report for an open-weight or hosted model workload, while collecting enough evidence to trust the result. A sub-part is now a folder so longer topics can grow without forcing everything into one huge page.
...
- Define FPGA ASIC and Dataflow Thinking in plain language before naming tools or frameworks.
...
- I can explain FPGA ASIC and Dataflow Thinking without naming a tool first.
