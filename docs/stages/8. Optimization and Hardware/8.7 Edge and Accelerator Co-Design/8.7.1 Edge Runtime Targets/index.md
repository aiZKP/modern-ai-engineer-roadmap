# 8.7.1 Edge Runtime Targets

## Why This Sub-Part Matters

Edge Runtime Targets is the working skill inside Edge and Accelerator Co-Design that helps you build the stage artifact, An inference benchmark and optimization report for an open-weight or hosted model workload, while collecting enough evidence to trust the result. A sub-part is now a folder so longer topics can grow without forcing everything into one huge page.
...
- Define Edge Runtime Targets in plain language before naming tools or frameworks.
...
- I can explain Edge Runtime Targets without naming a tool first.
