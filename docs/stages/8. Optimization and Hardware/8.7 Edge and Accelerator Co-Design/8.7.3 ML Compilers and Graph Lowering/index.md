# 8.7.3 ML Compilers and Graph Lowering

## Why This Sub-Part Matters

ML Compilers and Graph Lowering is the working skill inside Edge and Accelerator Co-Design that helps you build the stage artifact, An inference benchmark and optimization report for an open-weight or hosted model workload, while collecting enough evidence to trust the result. A sub-part is now a folder so longer topics can grow without forcing everything into one huge page.
...
- Define ML Compilers and Graph Lowering in plain language before naming tools or frameworks.
...
- Measure it with: power, thermals, memory, software support, and throughput
...
4. Add one measurement using: Track power, thermals, memory, software support, and throughput.

## Completion Standard

- I can explain ML Compilers and Graph Lowering without naming a tool first.
...
Return to [8.7 Edge and Accelerator Co-Design](<../index.md>).
