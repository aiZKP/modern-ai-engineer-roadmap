# 8.3.1 Quantization Formats

## Why This Sub-Part Matters

Quantization Formats is the working skill inside Model Optimization that helps you build the stage artifact, An inference benchmark and optimization report for an open-weight or hosted model workload, while collecting enough evidence to trust the result. A sub-part is now a folder so longer topics can grow without forcing everything into one huge page.
...
- Define Quantization Formats in plain language before naming tools or frameworks.
...
- I can explain Quantization Formats without naming a tool first.
