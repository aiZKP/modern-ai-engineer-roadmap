# 8.3.3 Distillation and Pruning

## Why This Sub-Part Matters

Distillation and Pruning is the working skill inside Model Optimization that helps you build the stage artifact, An inference benchmark and optimization report for an open-weight or hosted model workload, while collecting enough evidence to trust the result. A sub-part is now a folder so longer topics can grow without forcing everything into one huge page.
...
- Define Distillation and Pruning in plain language before naming tools or frameworks.
...
- I can explain Distillation and Pruning without naming a tool first.
