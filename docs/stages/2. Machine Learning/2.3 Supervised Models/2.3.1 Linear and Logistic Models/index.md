# 2.3.1 Linear and Logistic Models

## Why This Sub-Part Matters

Linear and Logistic Models is the working skill inside Supervised Models that helps you build the stage artifact, An ML baseline report comparing simple and stronger models with metrics, error slices, and a model card, while collecting enough evidence to trust the result. A sub-part is now a folder so longer topics can grow without forcing everything into one huge page.
...
- Define Linear and Logistic Models in plain language before naming tools or frameworks.
...
- I can explain Linear and Logistic Models without naming a tool first.
