# 2.1.4 Baseline Definition

## Why This Sub-Part Matters

Baseline Definition is the working skill inside Problem Framing that helps you build the stage artifact, An ML baseline report comparing simple and stronger models with metrics, error slices, and a model card, while collecting enough evidence to trust the result. A sub-part is now a folder so longer topics can grow without forcing everything into one huge page.
...
- Define Baseline Definition in plain language before naming tools or frameworks.
...
- I can explain Baseline Definition without naming a tool first.
