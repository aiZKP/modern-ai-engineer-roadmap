# 5.7.2 Input and Output Guardrails
...
- Define Input and Output Guardrails in plain language before naming tools or frameworks.
...
- I can explain Input and Output Guardrails without naming a tool first.
