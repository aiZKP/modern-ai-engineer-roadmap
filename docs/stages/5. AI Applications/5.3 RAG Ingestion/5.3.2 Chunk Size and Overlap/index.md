# 5.3.2 Chunk Size and Overlap

## Why This Sub-Part Matters

Chunk Size and Overlap is the working skill inside RAG Ingestion that helps you build the stage artifact, An evaluated RAG or AI workflow application with documents, prompts, tests, logs, latency, cost, and failure analysis, while collecting enough evidence to trust the result. A sub-part is now a folder so longer topics can grow without forcing everything into one huge page.
...
- Define Chunk Size and Overlap in plain language before naming tools or frameworks.
...
- I can explain Chunk Size and Overlap without naming a tool first.
