# Examples and Practice: Hybrid Search

## Worked Practice

1. Write one paragraph explaining Hybrid Search to a beginner.
...
Create a file named `notes/hybrid-search.md` in your project workspace. Include:
...
|---|---|
| Why does Hybrid Search matter? | It connects to an evaluated rag or ai workflow application with documents, prompts, tests, logs, latency, cost, and failure analysis. and names a practical risk. |
