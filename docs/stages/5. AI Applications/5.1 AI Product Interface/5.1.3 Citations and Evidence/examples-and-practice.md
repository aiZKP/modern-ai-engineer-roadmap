# Examples and Practice: Citations and Evidence

## Worked Practice

1. Write one paragraph explaining Citations and Evidence to a beginner.
...
Create a file named `notes/citations-and-evidence.md` in your project workspace. Include:

- the problem Citations and Evidence solves
...
|---|---|
| Why does Citations and Evidence matter? | It connects to an evaluated rag or ai workflow application with documents, prompts, tests, logs, latency, cost, and failure analysis. and names a practical risk. |
