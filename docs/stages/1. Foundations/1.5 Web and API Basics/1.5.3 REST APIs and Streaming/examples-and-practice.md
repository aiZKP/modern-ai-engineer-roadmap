# Examples and Practice: REST APIs and Streaming

## Worked Practice

1. Write one paragraph explaining REST APIs and Streaming to a beginner.
...
Create a file named `notes/rest-apis-and-streaming.md` in your project workspace. Include:

- the problem REST APIs and Streaming solves
...
|---|---|
| Why does REST APIs and Streaming matter? | It connects to a tested python data application with a cli or api, setup notes, and a short data report. and names a practical risk. |
