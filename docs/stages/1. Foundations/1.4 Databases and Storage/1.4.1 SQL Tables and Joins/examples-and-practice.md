# Examples and Practice: SQL Tables and Joins

## Worked Practice

1. Write one paragraph explaining SQL Tables and Joins to a beginner.
...
Create a file named `notes/sql-tables-and-joins.md` in your project workspace. Include:

- the problem SQL Tables and Joins solves
...
|---|---|
| Why does SQL Tables and Joins matter? | It connects to a tested python data application with a cli or api, setup notes, and a short data report. and names a practical risk. |
