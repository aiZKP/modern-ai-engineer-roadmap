# Examples and Practice: Complexity and Runtime Costs

## Worked Practice

1. Write one paragraph explaining Complexity and Runtime Costs to a beginner.
...
Create a file named `notes/complexity-and-runtime-costs.md` in your project workspace. Include:

- the problem Complexity and Runtime Costs solves
...
|---|---|
| Why does Complexity and Runtime Costs matter? | It connects to a tested python data application with a cli or api, setup notes, and a short data report. and names a practical risk. |
