# 3.1.4 Backpropagation and Autograd
...
- Define Backpropagation and Autograd in plain language before naming tools or frameworks.
...
- Measure it with: Plot loss, accuracy, gradients, and one failed run
...
4. Add one measurement using: Plot loss, accuracy, gradients, and one failed run.

## Completion Standard

- I can explain Backpropagation and Autograd without naming a tool first.
...
Return to [3.1 Neural Network Core](<../index.md>).
