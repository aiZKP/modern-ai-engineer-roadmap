# 3.4.2 Attention as a Bridge to Transformers
...
- Define Attention as a Bridge to Transformers in plain language before naming tools or frameworks.
...
- Measure it with: quality and speed across variants
...
4. Add one measurement using: Compare quality and speed across variants.

## Completion Standard

- I can explain Attention as a Bridge to Transformers without naming a tool first.
...
Return to [3.4 Architectures and Modalities](<../index.md>).
