# 3.5.1 Sanity Checks and Tiny Overfit Tests
...
- Define Sanity Checks and Tiny Overfit Tests in plain language before naming tools or frameworks.
...
- I can explain Sanity Checks and Tiny Overfit Tests without naming a tool first.
...
Return to [3.5 Debugging Neural Systems](<../index.md>).
