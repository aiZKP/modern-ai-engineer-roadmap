# Examples and Practice: Profiling Training Runs

## Worked Practice

1. Write one paragraph explaining Profiling Training Runs to a beginner.
...
Create a file named `notes/profiling-training-runs.md` in your project workspace. Include:

- the problem Profiling Training Runs solves
...
|---|---|
| Why does Profiling Training Runs matter? | It connects to a pytorch training project with loops, validation curves, checkpoints, ablations, and debugging notes. and names a practical risk. |
