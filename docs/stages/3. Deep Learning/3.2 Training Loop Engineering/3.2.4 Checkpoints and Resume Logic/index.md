# 3.2.4 Checkpoints and Resume Logic
...
- Define Checkpoints and Resume Logic in plain language before naming tools or frameworks.
...
- I can explain Checkpoints and Resume Logic without naming a tool first.
