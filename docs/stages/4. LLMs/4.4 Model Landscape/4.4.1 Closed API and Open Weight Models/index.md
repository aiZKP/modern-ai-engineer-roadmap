# 4.4.1 Closed API and Open Weight Models
...
- Define Closed API and Open Weight Models in plain language before naming tools or frameworks.
...
4. Add one measurement using: Report quality, latency, cost per success, privacy, license, and operations.

## Completion Standard

- I can explain Closed API and Open Weight Models without naming a tool first.
...
Return to [4.4 Model Landscape](<../index.md>).
