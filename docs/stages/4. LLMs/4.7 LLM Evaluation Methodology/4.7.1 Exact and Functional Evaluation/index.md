# 4.7.1 Exact and Functional Evaluation
...
- Define Exact and Functional Evaluation in plain language before naming tools or frameworks.
...
- Measure it with: exact pass rate, rubric scores, judge agreement, and failure categories
...
4. Add one measurement using: Track exact pass rate, rubric scores, judge agreement, and failure categories.

## Completion Standard

- I can explain Exact and Functional Evaluation without naming a tool first.
...
Return to [4.7 LLM Evaluation Methodology](<../index.md>).
