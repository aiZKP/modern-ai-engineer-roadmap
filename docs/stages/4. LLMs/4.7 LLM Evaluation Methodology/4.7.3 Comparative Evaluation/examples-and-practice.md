# Examples and Practice: Comparative Evaluation

## Worked Practice

1. Write one paragraph explaining Comparative Evaluation to a beginner.
2. Draw the smallest diagram that shows input, transformation, output, and failure mode.
3. Build or outline a tiny artifact connected to: Create a 30-case eval set.
4. Measure it with: Track exact pass rate, rubric scores, judge agreement, and failure categories.
5. Add one failure case to your learning log.

## Mini Project Drill

Create a file named `notes/comparative-evaluation.md` in your project workspace. Include:

- the problem Comparative Evaluation solves
...
|---|---|
| Why does Comparative Evaluation matter? | It connects to an llm fundamentals notebook comparing models, tokenization, structured outputs, embeddings, costs, and failure cases. and names a practical risk. |
