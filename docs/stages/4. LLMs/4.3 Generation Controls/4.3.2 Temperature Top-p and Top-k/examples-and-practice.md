# Examples and Practice: Temperature Top-p and Top-k

## Worked Practice

1. Write one paragraph explaining Temperature Top-p and Top-k to a beginner.
...
Create a file named `notes/temperature-top-p-and-top-k.md` in your project workspace. Include:

- the problem Temperature Top-p and Top-k solves
...
|---|---|
| Why does Temperature Top-p and Top-k matter? | It connects to an llm fundamentals notebook comparing models, tokenization, structured outputs, embeddings, costs, and failure cases. and names a practical risk. |
