# Examples and Practice: Stop Sequences and Max Tokens

## Worked Practice

1. Write one paragraph explaining Stop Sequences and Max Tokens to a beginner.
...
Create a file named `notes/stop-sequences-and-max-tokens.md` in your project workspace. Include:

- the problem Stop Sequences and Max Tokens solves
...
|---|---|
| Why does Stop Sequences and Max Tokens matter? | It connects to an llm fundamentals notebook comparing models, tokenization, structured outputs, embeddings, costs, and failure cases. and names a practical risk. |
