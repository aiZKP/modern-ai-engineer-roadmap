# 4.1.2 Context Windows and Truncation
...
- Define Context Windows and Truncation in plain language before naming tools or frameworks.
...
4. Add one measurement using: Report token counts, truncation risks, cost, and latency.

## Completion Standard

- I can explain Context Windows and Truncation without naming a tool first.
...
Return to [4.1 Token and Context Mechanics](<../index.md>).
