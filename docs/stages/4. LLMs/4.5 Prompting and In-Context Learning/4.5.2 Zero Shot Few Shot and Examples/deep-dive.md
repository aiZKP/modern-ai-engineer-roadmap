# Deep Dive: Zero Shot Few Shot and Examples
...
- Input: identify what raw information, code, data, prompt, model output, trace, or user signal Zero Shot Few Shot and Examples consumes.
...
- Failure mode: record how Zero Shot Few Shot and Examples can fail specifically in LLMs, not only in theory.
...
A strong learner can point to a small artifact, explain the tradeoff, show a measurement, and name the next improvement. For Zero Shot Few Shot and Examples, that means the explanation is grounded in Prompting and In-Context Learning and the stage artifact rather than floating as general AI vocabulary.

Return to [4.5.2 Zero Shot Few Shot and Examples](<index.md>).
