...
- Define Prompt Anatomy in plain language before naming tools or frameworks.
...
- I can explain Prompt Anatomy without naming a tool first.
...
Return to [4.5 Prompting and In-Context Learning](<../index.md>).
