# 10.1.3 Architecture Decision Records
...
- Define Architecture Decision Records in plain language before naming tools or frameworks.
...
- Measure it with: requirements, alternatives, risks, eval plan, and operations
...
4. Add one measurement using: Review requirements, alternatives, risks, eval plan, and operations.

## Completion Standard

- I can explain Architecture Decision Records without naming a tool first.
...
Return to [10.1 Capstone Problem and Architecture](<../index.md>).
