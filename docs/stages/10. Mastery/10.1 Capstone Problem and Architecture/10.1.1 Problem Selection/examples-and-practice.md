# Examples and Practice: Problem Selection

## Worked Practice

1. Write one paragraph explaining Problem Selection to a beginner.
...
Create a file named `notes/problem-selection.md` in your project workspace. Include:

- the problem Problem Selection solves
...
|---|---|
| Why does Problem Selection matter? | It connects to a capstone ai system with architecture, implementation, evaluation, deployment, observability, cost, security review, and portfolio narrative. and names a practical risk. |
