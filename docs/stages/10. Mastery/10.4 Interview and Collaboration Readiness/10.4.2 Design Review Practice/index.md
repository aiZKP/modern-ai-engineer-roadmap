...
- Define Design Review Practice in plain language before naming tools or frameworks.
...
4. Add one measurement using: Track clarity, specificity, evidence, and tradeoff explanations.

## Completion Standard

- I can explain Design Review Practice without naming a tool first.
...
Return to [10.4 Interview and Collaboration Readiness](<../index.md>).
