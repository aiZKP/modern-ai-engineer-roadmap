# Examples and Practice: Integration Testing

## Worked Practice

1. Write one paragraph explaining Integration Testing to a beginner.
...
Create a file named `notes/integration-testing.md` in your project workspace. Include:
...
|---|---|
| Why does Integration Testing matter? | It connects to a capstone ai system with architecture, implementation, evaluation, deployment, observability, cost, security review, and portfolio narrative. and names a practical risk. |
