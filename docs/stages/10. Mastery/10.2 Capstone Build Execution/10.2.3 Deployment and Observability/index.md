# 10.2.3 Deployment and Observability
...
- Define Deployment and Observability in plain language before naming tools or frameworks.
...
- Measure it with: milestones, eval trend, latency, cost, bugs, and reliability
...
4. Add one measurement using: Track milestones, eval trend, latency, cost, bugs, and reliability.

## Completion Standard

- I can explain Deployment and Observability without naming a tool first.
...
Return to [10.2 Capstone Build Execution](<../index.md>).
